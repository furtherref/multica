...
describe("useRealtimeSync — ws instance change", () => {
  ...
  it("invalidates exactly once when a new ws instance appears after null gap", () => {
    ...
    // (19 workspace-scoped [incl. labels, issue templates, property
    // definitions, the issue-status catalog, and the workspace working-agents
    // projection] + 6 per-issue prefixes + 5 per-chat prefixes + 1
    // workspaceKeys.list() + 1 cross-workspace inbox unread summary = 32 calls)
