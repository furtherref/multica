...
// The fork's cloud deployment serves the API and the app from one host.
const (
	defaultCloudServerURL = "https://multica.furtherref.com"
	defaultCloudAppURL    = "https://multica.furtherref.com"
)
