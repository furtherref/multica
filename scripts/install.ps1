...
#   $env:MULTICA_MODE="local"; irm https://raw.githubusercontent.com/furtherref/multica/main/scripts/install.ps1 | iex
#
...
# Configuration
# ---------------------------------------------------------------------------
$RepoUrl       = "https://github.com/furtherref/multica.git"
$RepoWebUrl    = "https://github.com/furtherref/multica"
...
function Get-LatestVersion {
    try {
        $release = Invoke-RestMethod -Uri "https://api.github.com/repos/furtherref/multica/releases/latest" -ErrorAction Stop
...
function Install-CliBinary {
    ...
    $url = "https://github.com/furtherref/multica/releases/download/$latest/multica-cli-$version-windows-$arch.zip"
    ...
    $checksumUrl = "https://github.com/furtherref/multica/releases/download/$latest/checksums.txt"
    try {
...
function Start-LocalInstall {
    ...
    Write-Host '     $env:MULTICA_MODE="stop"; irm https://raw.githubusercontent.com/furtherref/multica/main/scripts/install.ps1 | iex'
    Write-Host ""
}
