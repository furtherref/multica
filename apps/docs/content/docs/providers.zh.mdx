...
**14 款工具里有 12 款实际消费 `mcp_config`：Claude Code、CodeBuddy、Codex、Copilot、Cursor、Hermes、Kimi、Kiro CLI、OpenCode、OpenClaw、Qoder、Trae CLI**。其他 2 款（Antigravity、Pi）会接收这个字段但**忽略**——不报错、不警告，只是配置不生效。
