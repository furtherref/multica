...
For mobile development, using the Simulator, or connecting to staging, see [`apps/mobile/README.md`](https://github.com/furtherref/multica/blob/main/apps/mobile/README.md) in the repository.
