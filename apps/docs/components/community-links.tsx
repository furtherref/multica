/**
 * Fork-owned Discord invite. Dormant until this fork has its own community —
 * we never point readers at the upstream project's Discord. Setting a URL here
 * lights the entry back up. The X/Twitter entry is deliberately absent: it
 * would only ever be upstream's handle.
 */
const DISCORD_URL = "";
...
export function CommunityLinks({
  ...
  const links = [
    ...
    {
      label: "GitHub",
      href: "https://github.com/furtherref/multica",
